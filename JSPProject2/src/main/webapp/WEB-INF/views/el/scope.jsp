...
<body>
    ...
    <pre>
		...
		****************************
		...
		-> setAttirbute("key", value)로 내장 객체가 값을 세팅할 때
		key값이 중복되는 경우
