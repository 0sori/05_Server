...
@WebServlet("/scope") // 무조건 절대 경로 방식으로 요청주소작성
public class ScopeServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		// 2) application scope 범위로 값 세팅
		application.setAttribute("appValue", "애플리케이션 범위값");
		
		// * page, request, session, appication은 모두 사용법이 동일 *
